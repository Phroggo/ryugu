...
\hline
Subsystem & Components Included & Mass (kg) & Mass Fraction \\ \hline
...
\begin{tabular}{|l|l|l|l|}
\hline
Scheme & Impact v (mm/s) & Rebound v (mm/s) & Outcome \\ \hline
...
\begin{tabular}{|l|l|l|}
\hline
$c$ (N\,\textperiodcentered\,m\,\textperiodcentered\,s/rad) & Separation velocity & Landing behavior \\ \hline
...
\begin{tabular}{|l|l|l|l|}
\hline
Operational State & Subsystem & Peak Power (W) & Avg Continuous Power (W) \\ \hline
...
\caption{The mission telemetry dashboard during a live run --- differentiated roles (one RELAY, two SAMPLERs en route), per-agent battery and charge rate, attitude indicators, leg and reaction-wheel state.}
\label{fig:11}
\end{figure}
...
\begin{figure}[!t]\centering
\includegraphics[width=\columnwidth]{fig_sampling_dashboard_2.png}
\caption{The dashboard moments later: scout\_3's core is cached (drill retracted) and the agent is already "En route to anomaly (34 m remaining)" --- carousel chaining lets one SAMPLER service consecutive targets before returning.}
\label{fig:16}
\end{figure}
