...
The maneuver rolls the body upright with the reaction wheels, and its final form was reached through a documented failure-driven redesign (§7, §8) that is worth reporting in full because the intermediate failures are themselves the instructive result. The deployed maneuver has three coupled elements:
